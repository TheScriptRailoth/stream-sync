...
class _DiscoveryPage extends State<DiscoveryPage> {
  ...
  _DiscoveryPage() : isDiscovering=false;
              ...
              onTap: () async {
                try {
                  ...
                  if (result.device.isBonded) {
                    ...
                    bool? resultBonded = await FlutterBluetoothSerial.instance
                        .bondDeviceAtAddress(result.device.address);

                    // Check if the result from the await is not null before assigning.
                    if (resultBonded != null) {
                      // Only assign to bonded if resultBonded is not null.
                      bonded = resultBonded;
                    }
